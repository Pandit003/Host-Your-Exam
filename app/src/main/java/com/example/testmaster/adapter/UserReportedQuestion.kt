...
class UserReportedQuestion(var context : Context, var userReportedQuestionsList : List<model_reportedQuestion>) : RecyclerView.Adapter<UserReportedQuestion.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserReportedQuestion.ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.layout_user_reported,parent,false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: UserReportedQuestion.ViewHolder, position: Int) {
        holder.subject_name.text = userReportedQuestionsList[position].subject_name
        holder.tv_report_title.text = userReportedQuestionsList[position].report_title
        holder.tv_report_description.text = "Report description : ${userReportedQuestionsList[position].report_description}"
        holder.ll_report_question.setOnClickListener {
            ...
            tv_question.text = userReportedQuestionsList[position].question_text
            tv_option_a.text = userReportedQuestionsList[position].option_a
            tv_option_b.text = userReportedQuestionsList[position].option_b
            tv_option_c.text = userReportedQuestionsList[position].option_c
            tv_option_d.text = userReportedQuestionsList[position].option_d
            var correctAnswer = userReportedQuestionsList[position].correct_answer
    ...
    override fun getItemCount(): Int {
       return userReportedQuestionsList.size
    }
